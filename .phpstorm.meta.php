...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/mark/Repos/GitHub/ScoutingRudyardKipling/PhotoBook/public/storage' => 'string',
...
'filesystems.disks.old.driver','filesystems.disks.old.root','filesystems.disks.temp.driver','filesystems.disks.temp.root','filesystems.links./Users/mark/Repos/GitHub/ScoutingRudyardKipling/PhotoBook/public/storage',
...
'media-library.image_optimizers.Spatie\\ImageOptimizer\\Optimizers\\Pngquant','media-library.image_optimizers.Spatie\\ImageOptimizer\\Optimizers\\Optipng','media-library.image_optimizers.Spatie\\ImageOptimizer\\Optimizers\\Svgo','media-library.image_optimizers.Spatie\\ImageOptimizer\\Optimizers\\Gifsicle','media-library.image_generators',
...
'media-library.enable_vapor_uploads','media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','media-library.conversion_file_namer',
...
'services.sparkpost.secret','services.stripe.model','services.stripe.key','services.stripe.secret','services.stripe.webhook.secret',
'services.stripe.webhook.tolerance','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'verified','role','permission','role_or_permission',);
        registerArgumentsSet('routes', 'login','logout','home',
'album.store','album.show','album.edit','album.update','album.destroy',
'album.create','content.upload','content.create','content.store',
'content.show','content.edit','content.update','content.destroy','media.get',
...
'app.action.Back','app.bool.true','app.bool.false','app.Parent','app.sub',
'app.files','app.album','app.Album','app.Albums','app.user',
'app.users','app.User','app.name','app.Content','app.Featured',
'app.content','app.Empty','app.Top level','app.Summer camp','app.Group picture',
'app.to the','app.enable-javascript','app.Dashboard','app.Role','auth.login',
'auth.logout','auth.register','auth.remember me','auth.forgot','auth.email',
'auth.birth date','auth.gender.M','auth.gender.V','auth.gender.U','auth.preferred language',
'auth.external_user','auth.name','auth.leave-blank','auth.confirm','auth.sol.name',
'auth.sol.trough','auth.sol.username','auth.with username and password','auth.You are not logged in!','auth.sol-login-or-email-login',
'passwords.password','validation.file-valid-and-size','validation.not-valid-warning','validation.are-you-sure','auth.gender',
'auth.genders.M','auth.genders.V','auth.genders.U','validation.password','validation.attributes.address',
'validation.attributes.age','validation.attributes.amount','validation.attributes.available','validation.attributes.city','validation.attributes.content',
'validation.attributes.country','validation.attributes.currency','validation.attributes.date','validation.attributes.date_of_birth','validation.attributes.day',
'validation.attributes.description','validation.attributes.duration','validation.attributes.email','validation.attributes.excerpt','validation.attributes.first_name',
'validation.attributes.gender','validation.attributes.group','validation.attributes.hour','validation.attributes.last_name','validation.attributes.lesson',
'validation.attributes.message','validation.attributes.minute','validation.attributes.mobile','validation.attributes.month','validation.attributes.name',
'validation.attributes.password','validation.attributes.password_confirmation','validation.attributes.phone','validation.attributes.price','validation.attributes.second',
'validation.attributes.sex','validation.attributes.size','validation.attributes.street','validation.attributes.student','validation.attributes.subject',
'validation.attributes.teacher','validation.attributes.time','validation.attributes.title','validation.attributes.username','validation.attributes.year',);
