...
'broadcasting.connections.redis.connection','cache.default','cache.stores.array.driver','cache.stores.session.driver','cache.stores.session.key',
...
'database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.mysql_staf.driver','database.connections.mysql_staf.url',
'database.connections.mysql_staf.host','database.connections.mysql_staf.port','database.connections.mysql_staf.database','database.connections.mysql_staf.username','database.connections.mysql_staf.password',
'database.connections.mysql_staf.unix_socket','database.connections.mysql_staf.charset','database.connections.mysql_staf.collation','database.connections.mysql_staf.prefix','database.connections.mysql_staf.prefix_indexes',
'database.connections.mysql_staf.strict','database.connections.mysql_staf.engine','database.connections.mysql_staf.options','database.migrations','database.redis.client',
'database.redis.options.cluster','database.redis.options.prefix','database.redis.default.host','database.redis.default.password','database.redis.default.port',
...
'filesystems.disks.s3.region','filesystems.disks.s3.bucket','filesystems.disks.s3.url','filesystems.disks.media.driver','filesystems.disks.media.root',
'filesystems.disks.old.driver','filesystems.disks.old.root','filesystems.disks.temp.driver','filesystems.disks.temp.root','filesystems.links./home/wester50/Repos/github.com/scoutingrudyardkipling/PhotoBook/public/storage',
...
'mail.password','mail.sendmail','mail.log_channel','media-library.disk_name','media-library.conversions_disk_name',
...
'media-library.conversion_file_namer','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'debugbar.openhandler','debugbar.cache.delete','debugbar.queries.explain','debugbar.clockwork','debugbar.assets','login','logout','register','home','album.store','album.show','album.edit',
'album.update','album.destroy','album.create','content.upload','album.photos',
'photos.all','content.create','content.store','content.show',
'content.edit','content.update','content.destroy','media.get','user.index',
...
'validation.custom.attribute-name.rule-name','app.Actions','app.action.View','app.action.Edit','app.action.Create',
'app.action.Upload','app.action.Delete','app.action.deleting','app.action.Submit','app.action.Cancel',
'app.action.Back','app.action.Slideshow','app.Speed','app.seconds','app.bool.true',
'app.bool.false','app.Parent','app.sub','app.files','app.album',
'app.Album','app.Albums','app.user','app.users','app.User',
'app.name','app.Content','app.Featured','app.content','app.Empty',
'app.Top level','app.Summer camp','app.Group picture','app.to the','app.enable-javascript',
'app.Dashboard','app.Role','auth.login','auth.logout','auth.register',
'auth.remember me','auth.forgot','auth.email','auth.birth date','auth.gender.M',
'auth.gender.V','auth.gender.U','auth.preferred language','auth.external_user','auth.name',
'auth.leave-blank','auth.confirm','auth.sol.name','auth.sol.trough','auth.sol.username',
'auth.with username and password','auth.You are not logged in!','auth.sol-login-or-email-login','passwords.password','validation.file-valid-and-size',
'validation.not-valid-warning','validation.are-you-sure','auth.gender','auth.genders.M','auth.genders.V',
'auth.genders.U','validation.password','validation.attributes.address','validation.attributes.age','validation.attributes.amount',
'validation.attributes.available','validation.attributes.city','validation.attributes.content','validation.attributes.country','validation.attributes.currency',
'validation.attributes.date','validation.attributes.date_of_birth','validation.attributes.day','validation.attributes.description','validation.attributes.duration',
'validation.attributes.email','validation.attributes.excerpt','validation.attributes.first_name','validation.attributes.gender','validation.attributes.group',
'validation.attributes.hour','validation.attributes.last_name','validation.attributes.lesson','validation.attributes.message','validation.attributes.minute',
'validation.attributes.mobile','validation.attributes.month','validation.attributes.name','validation.attributes.password','validation.attributes.password_confirmation',
'validation.attributes.phone','validation.attributes.price','validation.attributes.second','validation.attributes.sex','validation.attributes.size',
'validation.attributes.street','validation.attributes.student','validation.attributes.subject','validation.attributes.teacher','validation.attributes.time',
'validation.attributes.title','validation.attributes.username','validation.attributes.year',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_DEFAULT_LANGUAGE','FORCE_HTTPS','LOG_CHANNEL','DB_CONNECTION','REGISTER',
